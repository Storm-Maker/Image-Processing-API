...
var isPictureProcessed_1 = __importDefault(require("../../utilites/isPictureProcessed"));
var listProcessedPictures_1 = __importDefault(require("../../utilites/listProcessedPictures"));
var app = (0, express_1.default)();
var processed = express_1.default.Router();
var rgx = /[a-zA-Z0-9]*\.jpg$/;
...
processed.get('/:filename', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var fileName, isPictureAvailable, ProcessedPics, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fileName = req.params.filename;
                return [4 /*yield*/, (0, isPictureProcessed_1.default)(fileName)];
            case 1:
                isPictureAvailable = _a.sent();
                _a.label = 2;
            case 2:
                _a.trys.push([2, 6, , 7]);
                if (!(fileName === '' ||
                    !isPictureAvailable ||
                    !fileName.includes('.jpg'))) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, listProcessedPictures_1.default)()];
            case 3:
                ProcessedPics = _a.sent();
